...
interface TrussBridgeSpecsModalProps {
    isOpen: boolean;
    onClose: () => void;
    specs: {
        material: 'steel' | 'wood';
    ...
    onSave: (specs: { material: 'steel' | 'wood'; maxLoad: number; safetyFactor: number }) => void;
}

const TrussBridgeSpecsModal: React.FC<TrussBridgeSpecsModalProps> = ({ isOpen, onClose, specs, onSave }) => {
    const [material, setMaterial] = useState<'steel' | 'wood'>(specs.material);
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-card rounded-xl shadow-2xl p-7 w-[370px] border border-border/60 backdrop-blur-md">
                <h2 className="text-xl font-bold mb-5 text-white">Edit Truss Bridge Specs</h2>
                <div className="mb-4">
...
export default TrussBridgeSpecsModal;
